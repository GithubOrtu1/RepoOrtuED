...
public class Pedidos extends javax.swing.JInternalFrame {
    ...
    private void btnRealizarPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarPedidoActionPerformed
        ...
        if(btnRealizarPedido.getText().equals("Realizar pedido")) {
            ...
            //Se comprueba que se haya seleccionado un cliente y una comida o bebida
            
            if(this.lstClientesDisponibles.getSelectedIndex()==-1){
                ...
                if((this.tbProductosDisponiblesComida.getSelectedRow()==-1) && (this.tbProductosDisponiblesBebida.getSelectedRow()==-1)){
                    try{
                    ...
                    int seleccionClientes,seleccionComida = -1,seleccionBebida = -1;
                    
                    seleccionClientes=lstClientesDisponibles.getSelectedIndex();
                    
                    if(tbProductosDisponiblesComida.getSelectedRow()!=-1){
                        
                            //Se selecciono una comida
                            
                            //A la hora se coger la seleccion del usuario hay que tener en cuanta que no se muestran los productos caducados con lo cual hay que buscar la seleccion
                            //del usuario en el arrayList asociado para convertir la seleccion del listado en la pos correcta del arrayList
                    
                             seleccionComida=tbProductosDisponiblesComida.getSelectedRow();
                             
                    
                            String nombreComidaSeleccion=tbProductosDisponiblesComida.getValueAt(seleccionComida,0).toString();
                            
                    
                            //Busco en los arrayList de Comida/Bebida la posicion del elemento con ese nombre
                    
                            for (int i=0;i<alComida3.size();i++){
                                if(nombreComidaSeleccion.equals(alComida3.get(i).getNombre())){
                                seleccionComida=i;
                                break;
                                }
                            }
                     ...
                     if(tbProductosDisponiblesBebida.getSelectedRow()!=-1){
                         
                         //Se selecciono una bebida
                         ...
                         String nombreBebidaSeleccion=tbProductosDisponiblesBebida.getValueAt(seleccionBebida,0).toString();
                         
                             for (int j=0;j<alBebida3.size();j++){
                                 if(nombreBebidaSeleccion.equals(alBebida3.get(j).getNombre())){
                                    seleccionBebida=j;
                                 break;
                                }   
                            }
        ...
        if(tipo=='C'){
            ...
            LocalDate fechaActual1=LocalDate.now();
                    ...
                    if( fechaCaducidad1.isBefore(fechaActual1) ){
                        ...
                        alComida3.get(pos).setEstado("CADUCADO");
        ...
        if(tipo=='B'){
            ...
            LocalDate fechaActual1=LocalDate.now();
                    ...
                    if( fechaCaducidad1.isBefore(fechaActual1) ){
                        ...
                        alBebida3.get(pos).setEstado("CADUCADO");
